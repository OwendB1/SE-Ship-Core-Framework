...
namespace ShipCoreFramework
{
    public static class GridsPerPlayerManager
    {
        ...
        public static void AddCubeGrid(GridLogic g)
        {
            ...
            list.Add(gridId);
            if (!_suppressEvents) LimitsNexusSync.BroadcastPlayerChange(new PlayerChange { PlayerId = playerId, CoreType = coreType, GridId = gridId, Added = true });
        }
        ...
        public static void RemoveCubeGrid(GridLogic g)
        {
            ...
            if (!_suppressEvents) LimitsNexusSync.BroadcastPlayerChange(new PlayerChange { PlayerId = playerId, CoreType = coreType, GridId = gridId, Added = false });
        }
