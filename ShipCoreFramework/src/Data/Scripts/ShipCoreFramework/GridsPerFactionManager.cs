...
namespace ShipCoreFramework
{
    public static class GridsPerFactionManager
    {
        ...
        public static void AddCubeGrid(GridLogic gridLogic)
        {
            ...
            list.Add(gridId);
            if (!_suppressEvents) LimitsNexusSync.BroadcastFactionChange(new FactionChange { FactionId = factionId, CoreType = coreType, GridId = gridId, Added = true });
        }
        ...
        public static void RemoveCubeGrid(GridLogic gridLogic)
        {
            ...
            if (!_suppressEvents) LimitsNexusSync.BroadcastFactionChange(new FactionChange { FactionId = factionId, CoreType = gridClassId, GridId = gridId, Added = false });
        }
